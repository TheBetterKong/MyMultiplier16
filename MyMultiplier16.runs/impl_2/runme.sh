...
HD_PWD='C:/Users/TheBetterKong/VivadoWorkplace/MyMultiplier16/MyMultiplier16.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log TopMultiplier.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopMultiplier.tcl -notrace
