...
HD_PWD='C:/Users/TheBetterKong/VivadoWorkplace/MyMultiplier16/MyMultiplier16.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log TopMultiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopMultiplier.tcl
